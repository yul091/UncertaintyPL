...
MODEL_TYPE=coderoberta # coderoberta, lstm, code2vec, graphcodebert
...
EPOCHS=100
BATCH=32 # 256 for code2vec, lstm, 32 for codebert, graphcodebert
LR=0.0001
...
CUDA_VISIBLE_DEVICES=4 python -m program_tasks.code_summary.main \
