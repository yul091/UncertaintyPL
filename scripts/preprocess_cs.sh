...
for DATASET_NAME in different_author different_project different_time; do
  ...
  echo "Extracting paths from dev set ..."
  ...
  echo "Finished extracting paths from dev set"
...
VAL_DIR=$DIR/dev
TEST_DIR=$DIR/test
TRG_DIR=dataset/code_summary/case_study
